...
class SharpsDataModule(pl.LightningDataModule):
    ...
    def setup(self,stage:str):
        ...
        self.train_set = SharpsDataset(self.df_train['filename'].tolist(),self.training_transform)
        self.val_set = SharpsDataset(df_val['filename'].tolist(),self.transform)
        self.pseudotest_set = SharpsDataset(df_pseudotest['filename'].tolist(),self.transform)
        self.test_set = SharpsDataset(df_test['filename'].tolist(),self.transform)
        self.trainval_set = SharpsDataset(pd.concat([self.df_train,df_val])['filename'].tolist(),self.transform)
    ...
    def subsample_trainset(self,filenames):
        ...
        self.subset_train_set = SharpsDataset(subset_filenames,self.training_transform)
